...
export const createCategory = ({ user_id, category_name }) =>
  post(`/user/${user_id}/create_category`, { user_id, category_name });
export const createTag = ({ user_id, category_id, tag_name }) =>
  post(`/user/${user_id}/create_tag`, { user_id, category_id, tag_name });
